      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-gray-900">
              Привлечение <span className="text-[#392AE7]">клиентов</span>{" "}
              для вашего бизнеса
            </h1>
