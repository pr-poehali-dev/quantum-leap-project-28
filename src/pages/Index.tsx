...
export default function Index() {
  return (
    <div className="min-h-screen">
      ...
      <footer className="border-t border-border bg-secondary/30 py-12" id="footer">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10 mb-10">
            <div className="md:col-span-1">
              <a href="/" className="text-lg font-bold font-display block mb-3">Вам Лям!</a>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#cases" className="hover:text-foreground transition-colors">Частные инвестиции</a></li>
                <li><a href="#cases" className="hover:text-foreground transition-colors">Франшизы</a></li>
                <li><a href="#cases" className="hover:text-foreground transition-colors">Недвижимость</a></li>
                <li><a href="#cases" className="hover:text-foreground transition-colors">Другие ниши</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="tel:+78001234567" className="hover:text-foreground transition-colors">8 800 123-45-67</a></li>
                <li><a href="mailto:hello@vamlyam.ru" className="hover:text-foreground transition-colors">hello@vamlyam.ru</a></li>
